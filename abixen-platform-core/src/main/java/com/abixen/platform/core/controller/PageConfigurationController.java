...
public class PageConfigurationController {
    ...
    @PreAuthorize("hasPermission(#id, 'com.abixen.platform.core.model.impl.Page', 'PAGE_VIEW')")
    ...
    @PreAuthorize("hasPermission(#id, 'com.abixen.platform.core.model.impl.Page', 'PAGE_ADD')")
    ...
    @PreAuthorize("hasPermission(#id, 'com.abixen.platform.core.model.impl.Page', 'PAGE_EDIT')")
    ...
    @PreAuthorize("hasPermission(#id, 'com.abixen.platform.core.model.impl.Page', 'PAGE_CONFIGURATION')")
