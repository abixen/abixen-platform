...
public class AdminSidebarItem extends AuditingModel implements AdminSidebarItemBase<ModuleType> {
    ...
    @JoinTable(
            name = "admin_sidebar_item_module_type",
            ...
            inverseJoinColumns = {@JoinColumn(
                    ...
                    nullable = false,
                    updatable = false)})
    private Set<ModuleType> moduleTypes = new HashSet<>();
