...
@Profile({DEV, DOCKER})
@Configuration
public class CoreRabbitMQConfiguration {

    private final RegisteredModuleServicesConfigurationProperties registeredModuleServicesConfigurationProperties;

    @Autowired
    public CoreRabbitMQConfiguration(RegisteredModuleServicesConfigurationProperties registeredModuleServicesConfigurationProperties) {
