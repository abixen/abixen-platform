...
INSERT INTO page (id, created_date, last_modified_date, description, name, title, layout_id, created_by_id, last_modified_by_id) VALUES (nextval('page_seq'), NULL, NULL, 'This is sample dashboard page #3', 'dashboard2', 'Some page name', 1, 2, 2);
