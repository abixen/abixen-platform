...
;var platformKpiChartModule = angular.module('platformKpiChartModule', ['platformKpiChartModuleServices', 'platformKpiChartModuleControllers', 'angular-svg-round-progress']);;var platformKpiChartModuleServices = angular.module('platformKpiChartModuleServices', ['ngResource']);
...
;var platformMagicNumberModule = angular.module('platformMagicNumberModule', ['platformMagicNumberModuleServices', 'platformMagicNumberModuleControllers']);;var platformMagicNumberModuleServices = angular.module('platformMagicNumberModuleServices', ['ngResource']);
...
platformChartModuleControllers.controller('ChartModulePreviewController', ['$scope', '$http', '$log', 'mockupData', function ($scope, $http, $log, mockupData) {
...
platformChartModuleServices.provider("mockupData", function () {
    ...
    var getCumulativeLineChart = function () {
        var options = {
            chart: {
    ...
    var getStackedAreaChart = function () {
        var options = {
            chart: {
    ...
    var getMultiColumnChart = function () {
        var options = {
            chart: {
                type: 'multiBarChart',
                height: 450,
    ...
    var getDiscreteColumnChart = function () {
        var options = {
            chart: {
    ...
    var getHistoricalColumnChart = function () {
        var options = {
            chart: {
