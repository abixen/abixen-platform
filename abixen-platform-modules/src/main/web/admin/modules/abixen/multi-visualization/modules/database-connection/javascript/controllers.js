...
databaseConnectionControllers.controller('DatabaseConnectionListController',
    ['$scope', '$http', '$log', 'uiGridConstants', 'DatabaseConnection', 'gridFilter', 'applicationNavigationItems', '$state',
        function ($scope, $http, $log, uiGridConstants, DatabaseConnection, gridFilter, applicationNavigationItems, $state) {
...
databaseConnectionControllers.controller('DatabaseConnectionDetailController',
    ['$scope', '$http', '$state', '$stateParams', '$log', 'DatabaseConnection', '$parse', 'toaster',
        function ($scope, $http, $state, $stateParams, $log, DatabaseConnection, $parse, toaster) {
