 ...
 * details.
 */
var commonSelectionModalWindowServices = angular.module('modalSelectionWindowService', []);

commonSelectionModalWindowServices.provider('modalSelectionWindow',
    function ModalSelectionWindow() {
        var okButtonClass = '';
