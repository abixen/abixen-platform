...
(function () {
    ...
    function platformUserModuleTranslateConfig($translateProvider) {
        ...
        $translateProvider.translations('POLISH', {
            ...
            'module.user.currentPassword.label': 'Aktualne hasło',
            'module.user.newPassword.label': 'Nowe hasło',
            'module.user.retypeNewPassword.label': 'Powtórzone nowe hasło',
            'module.user.validator.invalid.passwordMatch': 'Hasła muszą być takie same'
        });
        ...
        $translateProvider.translations('ENGLISH', {
            ...
            'module.user.currentPassword.label': 'Current password',
            'module.user.newPassword.label': 'New password',
            'module.user.retypeNewPassword.label': 'Retype new password',
            'module.user.validator.invalid.passwordMatch': 'Passwords must be the same'
        });
    }
})();