...
public class DataSetChartBuilder extends DataSetBuilder {
    ...
    @Override
    public DataSetChartBuilder domainSeries(final DataSetSeriesColumn domainXSeriesColumn, final DataSetSeriesColumn domainZSeriesColumn) {
        return (DataSetChartBuilder) super.domainSeries(domainXSeriesColumn, domainZSeriesColumn);
    }

    @Override
    public DataSetChartBuilder dataSetSeries(final Set<DataSetSeries> dataSetSeries) {
