...
import com.abixen.platform.service.businessintelligence.multivisualization.model.web.DatabaseConnectionWeb;
...
@Slf4j
@RestController
@RequestMapping(value = "/service/abixen/business-intelligence/admin/multi-visualization/database-connections")
