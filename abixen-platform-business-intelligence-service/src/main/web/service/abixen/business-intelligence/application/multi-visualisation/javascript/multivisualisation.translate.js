...
(function () {
    ...
    function platformChartModuleTranslateConfig($translateProvider) {
        ...
        $translateProvider.translations('RUSSIAN', {
            ...
            'module.multivisualisation.prev': 'Предидущий',
            ...
            'module.multivisualisation.configuration.preview.headerKey.label': 'Ключе',
            ...
            'module.multivisualisation.configuration.chartType.table.description': 'Только табличный вид. Используйте этот вид для просмотра данных без визуализации диаграммы.',
            'module.multivisualisation.configuration.chartType.lineChart.name': 'Линейная диаграмма',
            'module.multivisualisation.configuration.chartType.lineChart.description': 'Только линейная диаграмма. Используйте этот вид для презентации данных в виде линейной диаграммы.',
            ...
            'module.multivisualisation.configuration.chartType.lineAndBarChartWithFocus.name': 'Гистограмма и линейная диаграмма с фокусировкой',
