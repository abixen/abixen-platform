    ...
    function platformFileDataSourceModuleConfig($stateProvider) {
        $stateProvider
            .state('application.multiVisualisation.modules.fileDataSource', {
                ...
                templateUrl: '/service/abixen/business-intelligence/admin/multi-visualization/modules/file-data-source/html/index.html'
            })
            .state('application.multiVisualisation.modules.fileDataSource.list', {
                url: '/list',
                templateUrl: '/service/abixen/business-intelligence/admin/multi-visualization/modules/file-data-source/html/list.html',
            ...
            .state('application.multiVisualisation.modules.fileDataSource.add', {
                url: '/add',
                templateUrl: '/service/abixen/business-intelligence/admin/multi-visualization/modules/file-data-source/html/edit.html',
