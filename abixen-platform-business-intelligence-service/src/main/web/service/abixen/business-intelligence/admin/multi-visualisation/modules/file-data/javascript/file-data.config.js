    ...
    function platformFileDataModuleConfig($stateProvider) {
        $stateProvider
            .state('application.multiVisualisation.modules.fileData', {
                url: '/file-data',
                templateUrl: '/service/abixen/business-intelligence/admin/multi-visualization/modules/file-data/html/index.html'
            })
            .state('application.multiVisualisation.modules.fileData.list', {
                url: '/list',
                templateUrl: '/service/abixen/business-intelligence/admin/multi-visualization/modules/file-data/html/list.html',
                controller: 'FileDataListController',
                controllerAs: 'fileDataList'
            })
            .state('application.multiVisualisation.modules.fileData.add', {
                url: '/add',
                templateUrl: '/service/abixen/business-intelligence/admin/multi-visualization/modules/file-data/html/edit.html',
